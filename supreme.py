...
def main():
    accounts = [
#        Account('FirstName', 'LastName', 'email@domain.com', 'XXX-XXX-XXXX', Address('123 Main Street', 'APT 1A', '12345', 'Brooklyn', 'NY'), 
#                Card('visa', 'XXXX XXXX XXXX XXXX', 'XX', 'XXXX', 'XXX')),
        Account('John', 'Doe', 'foo@gmail.com', '123-456-8910', Address('123 Main St', '', '12345', 'Schenectady', 'NY'), 
                Card('visa', '1234 1234 1234 1234', '08', '2021', '982')),
    ]
